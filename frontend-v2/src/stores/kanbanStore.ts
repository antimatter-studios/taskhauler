...
import type { Board, Column, Epic, Card, Comment, CreateCardRequest, UpdateCardRequest } from "../api/types";
...
interface KanbanStore {
  ...
  // Card actions
  createCard: (boardId: string, req: CreateCardRequest) => Promise<Card>;
  updateCard: (boardId: string, cardId: string, req: UpdateCardRequest) => Promise<Card>;
