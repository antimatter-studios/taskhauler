...
// NewDB wraps an already-open *gorm.DB. AutoMigrate is expected to have been run.
...
// Raw returns the underlying *gorm.DB so other packages can share the connection.
